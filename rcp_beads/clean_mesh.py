...
def parse_args():
    ...
    parser.add_argument("-Lx", type=float, default=10., help="Length")
    parser.add_argument("-Ly", type=float, default=10., help="Length")
    parser.add_argument("-Lz", type=float, default=10., help="Length")
